...
set rc [catch {
  ...
  add_files -quiet C:/Users/ZYZ/Desktop/CLOCK/CLOCK.runs/synth_1/CLOCK.dcp
  read_xdc C:/Users/ZYZ/Desktop/CLOCK/CLOCK.srcs/constrs_1/new/CLOCK.xdc
  link_design -top CLOCK -part xc7a35ticpg236-1L
...
set rc [catch {
  ...
  report_drc -file CLOCK_drc_routed.rpt -pb CLOCK_drc_routed.pb -rpx CLOCK_drc_routed.rpx
  report_methodology -file CLOCK_methodology_drc_routed.rpt -rpx CLOCK_methodology_drc_routed.rpx
