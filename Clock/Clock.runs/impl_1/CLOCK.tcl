...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/Users/ZYZ/Desktop/CCCCC/Clock/Clock.cache/wt [current_project]
  catch { write_mem_info -force CLOCK.mmi }
  write_bitstream -force -no_partial_bitfile CLOCK.bit -bin_file
